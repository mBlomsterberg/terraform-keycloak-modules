output "id" {
  ...
  value       = try(keycloak_oidc_github_identity_provider.this[0].id, null)
}
...
output "alias" {
  ...
  value       = try(keycloak_oidc_github_identity_provider.this[0].alias, null)
}

output "internal_id" {
  description = "Internal ID assigned by Keycloak to the identity provider (distinct from the alias)."
  value       = try(keycloak_oidc_github_identity_provider.this[0].internal_id, null)
}
